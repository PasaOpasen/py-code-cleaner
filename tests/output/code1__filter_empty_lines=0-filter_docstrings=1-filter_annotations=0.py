...
def clean_py(file_from: PathLike, file_to: PathLike, filter_empty_lines: bool=True, filter_docstrings: bool=True, filter_annotations: bool=True) -> None:
    p = Path(file_from)
    assert p.exists(), p
    ...
    write_text(file_to, '\\n'.join(lines))
def clean_py_deep(dir_from: PathLike, dir_to: PathLike, keep_nonpy: Optional[Iterable[str]]=('.pyx',), verbose: bool=True, dry_run: bool=False, **clean_py_kwargs) -> None:
...
def clean_py_main(src: PathLike, dst: Optional[PathLike]=None, keep_nonpy: Optional[Iterable[str]]=('.pyx',), filter_empty_lines: bool=True, filter_docstrings: bool=True, filter_annotations: bool=True, quiet: bool=False, dry_run: bool=False):
